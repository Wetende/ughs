<!-- Footer -->
<footer class="bg-[#1b5454] text-white pt-16 pb-8">
        ...
        <div class="grid md:grid-cols-4 gap-8 mb-8">
            ...
            <div>
                ...
                <form class="space-y-4">
                    <div>
                        <input type="email" placeholder="Your email address" class="w-full px-4 py-2 rounded-lg bg-[#023D54] border border-gray-600 text-white placeholder-gray-400 focus:outline-none focus:border-yellow-500">
                    </div>
        ...
        <div class="border-t border-gray-700 pt-8">
            <div class="flex flex-col md:flex-row justify-between items-center">
                <p class="text-gray-400 text-sm mb-4 md:mb-0">
                    © {{ date('Y') }} Uasin Gishu High School. All rights reserved.
                </p>
